...
namespace LoginJWT_Sample_API.Services
{
    public interface ITokenService
    {
        ...
        string GenerateJWT(LoggedInUserDto user, IEnumerable<Claim>? additionalClaims = null);
    }
    ...
    public sealed class TokenService : ITokenService
    {
        ...
        public string GenerateJWT(LoggedInUserDto user, IEnumerable<Claim>? additionalClaims = null)
        {
            var claims = new List<Claim>
                {
